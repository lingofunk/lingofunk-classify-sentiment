...
class HNATT:
    ...
    def _build_model(self, n_classes=2, embedding_dim=300, embeddings_path=False):
        ...
        word_encoder = Bidirectional(
            GRU(40, return_sequences=True, kernel_regularizer=l2_reg)
        )(normalised_embedding)
        dense_transform_w = Dense(
            80, activation="relu", name="dense_transform_w", kernel_regularizer=l2_reg
        )(word_encoder)
        ...
        dense_transform_s = Dense(
            80, activation="relu", name="dense_transform_s", kernel_regularizer=l2_reg
        )(sentence_encoder)
